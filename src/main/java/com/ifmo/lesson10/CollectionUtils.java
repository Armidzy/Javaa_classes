...
public class CollectionUtils {
    ...
    public static <T> Iterable<T> view(Iterable<T>... iterables) {
        //используем Iterable чтобы итератор генерировался
        // только когда объект есть для производительности
        //return null;
        return view(el-> el, iterables);
...
//1.заменить Transformer на java.util.fucntion.Function
    ...
    public  static <T> Iterable<T> filteredView(Iterable<T> iterable, Predicate<T> predicate){
        //  созд новый итерабл кот возвр итератор
        return null;
    }
    ...
    public static void main(String[] args) {
        ...
        Iterable<Integer> view3= view((s) -> Integer.valueOf(s), list1, list2, list3); //лямбда
